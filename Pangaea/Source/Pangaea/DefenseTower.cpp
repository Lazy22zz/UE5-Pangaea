...
ADefenseTower::ADefenseTower()
{
	...
	static ConstructorHelpers::FObjectFinder<UBlueprint> blueprint_finder(TEXT("Blueprint'/Game/TopDown/Blueprints/Fireball/BP_Fireball.BP_Fireball'"));
...
void ADefenseTower::OnMeshBeginOverlap(AActor* OtherActor)
{
	...
	if (character->IsA(APlayerAvatar::StaticClass()) &&
		...
		CanBeDamaged())
	{
		Hit(Cast<APangaeaCharacter>(weapon->Holder)->Strength);
	}
}